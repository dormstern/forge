...
[Read the FAQ](docs/FAQ.md) — answers to "will `/forge:init` overwrite my files?", "how much does a cycle cost?", "does it work with Cursor?", "is this just a prompt wrapper?", and 15 other things.
